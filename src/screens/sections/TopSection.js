      ...
      <div className='container'>
        <div className='d-flex justify-content-between'>
          <div className='d-flex pt-2 pb-2'>
            <div className='d-flex align-item-center mr-3 numcolor'>
              <i className='fas fa-phone-alt mr-2' />
              <small>+27 (0) 813 190 025</small>
            </div>
            <div className='d-flex align-item-center  numcolor'>
              <i className='fas fa-envelope mr-2' />
              <small>creativepowerorganization123@gmail.com</small>
            </div>
          </div>
          <div className='d-flex pt-2 pb-2 numcolor2'>
